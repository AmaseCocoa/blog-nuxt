...
useHead(
    {
        ...
        title: content.title,
        meta: [
            { hid: 'description', name: 'description', content: 'けもみみを吸ったりコードを書いてたりVRChatをやってたりします...' },
            { hid: 'og:type', property: 'og:type', content: 'article' },
            { hid: 'og:title', property: 'og:title', content: content.title },
            { hid: 'og:description', property: 'og:description', content: 'けもみみを吸ったりコードを書いてたりVRChatをやってたりします...' },
